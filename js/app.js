...
//Tablero para verificar empate por no quedar movimientos
// var tableroArray = [
//   [null, null, null, null, null, 22, null, null],
//   [null, null, null, null, 1, null, null, null],
//   [null, null, null, null, null, 2, null, null],
//   [null, null, 2, null, 2, null, 2, null],
...
//Tablero para verificar empate por haber 2 reinas
// var tableroArray = [
//   [null, null, null, null, null, null, null, null],
...
function moverFicha(filaMover, columnaMover, tipoMovimiento, aMoverFila, aMoverColumna) {
  if (!((MovimientosPermitidos.SeguirMovComerDerArriba === false || MovimientosPermitidos.SeguirMovComerDerAbajo=== false 
    ...
    divViejo.innerHTML = '' //Elimino la dama de la casilla antigua
    tableroArray[damaSelec.idFila][damaSelec.idColumna] = null;  //Elimino la dama antigua del tablero
    MovimientosPermitidos.SeguirEnTurno = false //Vuelvo al turno del oponente, ya que se le saltea el turno por no comer cuando podia
  }
